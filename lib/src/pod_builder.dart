...
class PodBuilder<A, B> extends StatefulWidget {
  //
  //
  //
  ...
  factory PodBuilder.value({
    Key? key,
    ChainablePod<A, B>? pod,
    required Widget Function(dynamic) builder,
  }) {
    return PodBuilder<A, B>(
      pod: pod,
  ...
  @override
  PodBuilderState<A, B> createState() => PodBuilderState<A, B>();
}

// ░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░░

class PodBuilderState<A, B> extends State<PodBuilder<A, B>> {
  //
  //
  //
  ...
  Widget build(BuildContext context) {
    ...
    return widget.builder?.call(context, widget.child, widget.pod?.value) ??
        widget.child ??
        const SizedBox();
  }
